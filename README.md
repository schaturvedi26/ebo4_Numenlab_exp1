...
Unclosed HTML Tags :  Some HTML tags are not closed, for example (br)-break line  and ( hr) -horizontal line .br Tag: br stands for break line, it breaks the line of the code.</b> hr Tag: hr stands for Horizontal Rule. This tag is used to put a line across the webpage
